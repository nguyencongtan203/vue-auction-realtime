    ...
    <div v-else class="w-full max-w-3xl space-y-5">
      ...
      <div class="space-y-3 fade-in">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-2 flex-1">
            ...
            <span v-if="!emailVerified" class="text-red-600 text-sm font-medium italic">(Email chưa được xác thực)</span>
            <span v-else class="text-emerald-600 text-sm font-medium italic">(Đã xác thực)</span>
          </div>
        </div>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3 flex-1">
            ...
            <a href="#" class="text-sky-600 hover:text-sky-700 text-sm font-medium underline" @click.prevent="openChangePassword">Đổi mật khẩu</a>
          </div>
        </div>
      </div>
      ...
      <div class="space-y-4 fade-in">
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.ho" :disabled="!editing" :class="['input', errors.ho && 'error']" />
        ...
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.tenlot" :disabled="!editing" :class="['input', errors.tenlot && 'error']" />
        ...
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.ten" :disabled="!editing" :class="['input', errors.ten && 'error']" />
        ...
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.sdt" :disabled="!editing" :class="['input', errors.sdt && 'error']" />
        ...
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.diachi" placeholder="Chưa cập nhật" :disabled="!editing" :class="['input', errors.diachi && 'error']" />
        ...
        <div class="form-row">
          ...
          <div class="flex-1">
            <input v-model="user.diachigiaohang" placeholder="Chưa cập nhật" :disabled="!editing" :class="['input', errors.diachigiaohang && 'error']" />
            <p v-if="errors.diachigiaohang" class="error-msg">{{ errors.diachigiaohang }}</p>
          </div>
        </div>
      ...
      <div class="pt-6 flex justify-end gap-3">
        <button v-if="!editing" @click="enableEdit" class="inline-flex items-center bg-[#127fcf] hover:bg-[#1992eb] text-white px-4 py-2 rounded-xl font-semibold btn-flash">
          Chỉnh Sửa
        </button>
        <button v-else @click="saveChanges" class="inline-flex items-center bg-[#127fcf] hover:bg-[#1992eb] text-white px-4 py-2 rounded-xl font-semibold btn-flash" :disabled="saving">
...
const toastMeta = computed(() => {
  ...
  switch (type) {
    case "success":
      return { title: "Thành công!", barBg: "bg-emerald-500", titleColor: "text-emerald-500", iconPaths:[
    ...
    case "warning":
      return { title:"Cảnh báo!", barBg:"bg-yellow-400", titleColor:"text-yellow-400", iconPaths:[
    ...
    case "error":
      return { title:"Lỗi!", barBg:"bg-red-500", titleColor:"text-red-500", iconPaths:[
    ...
    default:
      return { title:"Thông báo", barBg:"bg-blue-500", titleColor:"text-blue-500", iconPaths:[
